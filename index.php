...
descriptionEditor.getModule('toolbar').container.style.pointerEvents = 'auto';
descriptionEditor.root.setAttribute('contenteditable', 'true');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (saveButton) {
        saveButton.addEventListener('click', function() {
            ...
            // Mengganti nilai atribut contenteditable saat selesai mengedit popup
            descriptionEditor.root.setAttribute('contenteditable', 'false');
            // Menghapus event listener tombol "Save" setelah disimpan
            saveButton.removeEventListener('click', arguments.callee);
        });
    }
});

// Menambahkan fitur scroll pada priview popup
var previewContainer = document.querySelector('.preview-popup');
